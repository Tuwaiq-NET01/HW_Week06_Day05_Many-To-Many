...
namespace CodeFirst.Migrations
{
    ...
    [Migration("20210602090739_CreateSubjectTableWithForginKey")]
    partial class CreateSubjectTableWithForginKey
    {
            ...
            modelBuilder.Entity("CodeFirst.Models.SubjectModel", b =>
                {
                    b.HasOne("CodeFirst.Models.Teacher", "Teacher")
                        .WithOne("Subject")
                        .HasForeignKey("CodeFirst.Models.SubjectModel", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
